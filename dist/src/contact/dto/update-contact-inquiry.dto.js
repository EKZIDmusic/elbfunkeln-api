...
class UpdateContactInquiryDto {
    status;
}
exports.UpdateContactInquiryDto = UpdateContactInquiryDto;
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.ContactStatus, example: client_1.ContactStatus.IN_PROGRESS }),
    (0, class_validator_1.IsEnum)(client_1.ContactStatus),
    __metadata("design:type", String)
], UpdateContactInquiryDto.prototype, "status", void 0);
